...
.chip{display:inline-flex;align-items:center;gap:3px;background:var(--chip-bg);border:1px solid var(--chip-border);border-radius:2px;padding:2px 6px;font-size:11px;cursor:grab;user-select:none;font-family:"SF Mono","Fira Code",Consolas,Monaco,monospace;cursor:default;transition:all 0.15s ease}
